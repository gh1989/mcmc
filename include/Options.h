...
class Options
{
    ...
    public:
        ...
        double zeta_sigma(){return _zeta_sigma;}
        double variance_sigma(){return _variance_sigma;}
        double real_sigma(){return _real_sigma;}
        double start_sigma(){return _start_sigma;}
        ...
        void set_zeta_sigma(double d){_zeta_sigma=d;}
        void set_variance_sigma(double d){_variance_sigma=d;}
    ...
    private:
        ...
        double _zeta_sigma                   = 0;
        double _variance_sigma               = 0.25;
        double _real_sigma                   = 0.5;
        double _start_sigma                  = 1.0;
